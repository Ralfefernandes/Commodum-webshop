                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input
                        type="text"
                        class="form-control"  v-model="country"
                        name="country"
                        value=""
                      />
                    </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-xs-12">
                      <strong>firstnaam:</strong>
                      <input
                        type="text"
                        name="first_name" v-model="firstName"
                        class="form-control"
                        value=""
                      />
                    </div>
                    ...
                    <div class="col-md-6 col-xs-12">
                      ...
                      <input
                        type="text"
                        name="last_name" v-model="lastName"
                        class="form-control"
                        value=""
                      />
                    </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-12"><strong>Stad:</strong></div>
                    <div class="col-md-12">
                      <input
                        type="text"
              ...
              <div class="panel panel-info">
                ...
                <div class="panel-body">
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <select
                        id="CreditCardType" v-model="cardType"
                        name="CreditCardType"
                        class="form-control"
                      >
              ...
              <div class="summary-content" v-if="summaryItem.name">
                ...
                <div class="summary-price">
                  ...
                  <span class="summary-small-text pull-right">
                    Q: {{ summaryItem.quantity }} x Prijs:
